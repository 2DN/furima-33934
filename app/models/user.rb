class User < ApplicationRecord
  ...
  validates_format_of :last_name_kanji, presence: true, with: VALID_KANJI_REGEX, message: 'には全角漢字を使用してください'
  validates_format_of :first_name_kanji, presence: true, with: VALID_KANJI_REGEX, message: 'には全角漢字を使用してください'
